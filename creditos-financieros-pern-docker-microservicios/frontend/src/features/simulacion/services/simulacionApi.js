// src/features/simulacion/services/simulacionApi.js
...
export const crearSimulacion = (data, token) => axios.post(`${API_URL}/api/simular`, data, { headers: { Authorization: `Bearer ${token}` } });
