...
const host = process.env.DB_HOST || process.env.PGHOST || 'db_simulacion';
const port = process.env.DB_PORT || process.env.PGPORT || 5432;
const user = process.env.DB_USER || process.env.PGUSER || 'postgres';
const password = process.env.DB_PASSWORD || process.env.PGPASSWORD || 'postgres';
const database = process.env.DB_NAME || process.env.PGDATABASE || process.env.POSTGRES_DB || 'simulacion_db';
